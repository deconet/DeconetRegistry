...
import "./lib/dll/contracts/DLL.sol";
import "./lib/attrstore/contracts/AttributeStore.sol";
...
contract PLCRVoting {
    ...
    */
    function getInsertPointForNumTokens(address _voter, uint _numTokens) constant public returns (uint prevNode) {
